  ...
  return (
    <nav className="flex items-center justify-between border-b-2 bg-[#393E46] px-6 md:px-16 lg:px-32 py-3 text-white">
      ...
      <div className="flex items-center gap-4 lg:gap-8 max-md:hidden">
        ...
        {isSeller && <button onClick={() => router.push('/seller')} className="text-xs border px-4 py-1.5 rounded-full hover:bg-white hover:text-gray-900 transition">Seller Dashboard</button>}
